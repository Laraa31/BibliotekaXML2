        ...
        private void btnUnos_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.No)
            {
                try
                {
                    ...
                    {
                        var Knjiga = new XElement("Korisnik", new XElement("Naziv", knjiga.Naziv), new XElement("Autor", knjiga.Autor),new XElement("Kolicina", knjiga.Kolicina), new XElement("ISBN", knjiga.ISBN));
